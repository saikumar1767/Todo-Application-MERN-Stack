...
app.use(cors({
  credentials: true,
  origin: "https://sk-react-todo.herokuapp.com"
}));
app.use(
  session({
...
// connect
const db = mongoose.createConnection("mongodb+srv://sk:venkat@1767@skmongo.b4ewm.mongodb.net/TodoApp?retryWrites=true&w=majority", {
